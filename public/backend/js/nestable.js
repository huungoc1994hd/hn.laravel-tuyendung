    ...
    Plugin.prototype = {
        ...
        setParent: function (li) {
            if (li.children(this.options.listNodeName).length) {
                if (li.children(`.${this.options.actionClass}`).length == 0) {
                    li.append(`<div class='${this.options.actionClass}'></div>`);
                }
                li.children(`.${this.options.actionClass}`).prepend($(this.options.expandBtnHTML));
                li.children(`.${this.options.actionClass}`).prepend($(this.options.collapseBtnHTML));
            }
